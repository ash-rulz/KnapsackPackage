...
What performance gain could you get by parallelizing brute force search?
    ...
    ```
Note: On parallelization, as seen above, the run-time as compared to non-parallelized brute force is more. When profiled, we found that the "makeCluster" line is taking up most time. Hence the delay while running in parallel mode.
